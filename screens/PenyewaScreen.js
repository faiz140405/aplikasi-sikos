...
const PenyewaScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        // onSnapshot akan mendengarkan perubahan data di Firestore secara real-time
        const unsubscribe = onSnapshot(collection(db, "penyewa"), (snapshot) => {
